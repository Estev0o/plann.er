...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The end date of the trip must be equal to or laater than the Start Date.
        /// </summary>
        public static string END_DATA_TRIP_MUST_BE_LATER_STARAT_DATE {
            get {
                return ResourceManager.GetString("END_DATA_TRIP_MUST_BE_LATER_STARAT_DATE", resourceCulture);
            }
        }
